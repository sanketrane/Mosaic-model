 ...
 */
void writeResultsToStream(Agebin &agebin, double time_now, std::stringstream &countsresstream, std::stringstream &kiresstream);
 ...
 */
void writeCloneFreqToStream(Agebin &agebin, double time_now, std::stringstream &nai_disstream, std::stringstream &nai_incstream, std::stringstream &mem_faststream, std::stringstream &mem_slowstream);
/**
